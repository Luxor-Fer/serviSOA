<%-- 
    Document   : template
    Created on : 29/01/2022, 23:20:25
    Author     : windows
--%>

<%@page import="Entidades.Sucursales"%>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="controlador?accion=datosUsuario" target="ventana"><%= usu.getNOM_USU() %></a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="controlador?accion=datosUsuario" target="ventana">Historial</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="controlador?accion=datosUsuario" target="ventana">Comprar</a>
        </li>

        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="controlador?accion=datosUsuario" target="ventana">Saldo: <%= usu.getSAL_USU() %></a>
        </li>
      </ul>
    </div>
  ...
  boton.onclick = function (){
    ...
    <section>
        <iframe name="ventana" style="height: 500px; width: 100%"></iframe>
    </section>
