<%-- 
    Document   : templateSucursal
    Created on : 04/02/2022, 23:55:28
    Author     : windows
--%>
...
<html>
    ...
    <% 
        ...
        Sucursales usu = (Sucursales)nombre.getAttribute("usuario");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="controlador?accion=datosUsuario" target="ventana"><%= usu.getNOM_SUC()%></a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="controlador?accion=datosUsuario" target="ventana">Clientes</a>
        </li>
        <li class="nav-item">
